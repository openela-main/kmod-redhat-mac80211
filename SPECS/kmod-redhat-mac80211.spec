...
%define kmod_install_path	extra/kmod-redhat-mac80211
...
%package -n kmod-redhat-mac80211-firmware
Version:	ENTER_FIRMWARE_VERSION
Summary:	mac80211 firmware for Driver Update Program
...
Provides:	%kernel_modules_pkg = %{kmod_kernel_version_dep}.%{_target_cpu}
%endif
%description -n  kmod-redhat-mac80211-firmware
mac80211 firmware for Driver Update Program


%files -n kmod-redhat-mac80211-firmware
...
mac80211 development files for Driver Update Program


%files -n kmod-redhat-mac80211-devel
%defattr(644,root,root,755)
...
%package -n kmod-redhat-mac80211-files
Version:	%{kmod_driver_version}
Summary:	mac80211 additional files for Driver Update Program
...
%description -n  kmod-redhat-mac80211-files
mac80211 additional files for Driver Update Program


%files -n kmod-redhat-mac80211-files
%defattr(644,root,root,755)
...
rpm -ql kmod-redhat-mac80211-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
